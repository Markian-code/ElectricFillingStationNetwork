Feature: Display User Invoice
  As an User
  I want to view my invoices
  so i have a overview on my top-ups and billed charging sessions

  Scenario: View detailed invoice of user account
    Given user "Michael" with email "michael@example.com" and the following top-ups exist:
      | amount | timestamp           |
