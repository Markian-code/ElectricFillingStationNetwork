Feature: Charging Session Management
  ...
  As a user of the electric charging network,
  I want to start and stop charging sessions,
  So that I can charge my vehicle and be billed accordingly.
  ...
  Scenario: Trying to calculate the cost for an unfinished session
    ...
    When user with email "florian@example.com" tries to calculate the total cost
